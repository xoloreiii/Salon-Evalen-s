        ...
        <div class="container justify-content-center">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active text-dark" aria-current="page" href="/salon/salonHome">Beranda</a>
                    </li>
                    <li class="nav-item">
    ...
    <body>
        ...
        <div style="text-align: center;">
            <form method="post" action="/salon/salonLogin">
                ...
                <div>
                    <h4> Email atau Password salah. Harap coba lagi. </h4>
                </div><br>
                <div>
                    <button class="login" href="/salon/salonLogin" style="border: none; background-color: #BD7272; color: #fff;">Coba lagi</button>
                </div>
            </form>
        </div>
    </body>
