    ...
    <body>
        <div style="text-align: center;">
            <form>
                ...
                <p style="text-align: center;">Anda tidak berhasil menghapus jasa</p>
                <a class="jasa" href="/salon/salonHapusJasa" style="display: inline-block; text-decoration: none; border: none; background-color: #BD7272; color: #fff; padding: 10px 20px; margin-right: 10px;">OK</a>
            </form>
        </div>
    </body>
</body>
