...
<body>
    ...
    <body>
        ...
        <div style="text-align: center;">
            <form method="post" action="/salon/salonLoginAdmin">
                <?= csrf_field() ?>
                ...
                <div>
                    <button class="login" href="/salon/salonLoginAdmin" style="border: none; background-color: #BD7272; color: #fff;">Coba lagi</button>
                </div>
            </form>
        </div>
    </body>
