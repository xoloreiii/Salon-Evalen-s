        ...
        <div style="text-align: center;">
            <form method="post" action="/salon/salonLogin">
                ...
                <div>
                    ...
                    <h3> Silakan login untuk masuk ke salon Evalen's.</h3>
                </div><br>
                <div>
                    <button class="login" href="/salon/salonLogin" style="border: none; background-color: #BD7272; color: #fff;">Masuk</button>
                </div>
            </form>
        </div>
    </body>
