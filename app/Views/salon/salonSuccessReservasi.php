...
<body>
    ...
    <body>
        ...
        <form>
            ...
            <h5 style="text-align: center;">Anda berhasil melakukan reservasi !</h5><br>
            <h6> Note : screenshot halaman ini sebagai bukti resevasi</h6><br>
            ...
            <div>
                ...
                <!-- Menampilkan nilai jasa -->
                <p>Jasa: <?= $jasa ?></p>

                <!-- Menampilkan nilai waktu reservasi -->
                <p>Waktu Reservasi: <?= $waktu_reservasi ?></p>

                <!-- Menampilkan nilai metode pembayaran -->
